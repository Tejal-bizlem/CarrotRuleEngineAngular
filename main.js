...
var map = {
	...
	"src/app/main/home/home.module": [
		"./src/app/main/home/home.module.ts",
		"src-app-main-home-home-module"
	],
	"src/app/main/setup-rule-step/setup-rule-step.module": [
		"./src/app/main/setup-rule-step/setup-rule-step.module.ts",
		"src-app-main-setup-rule-step-setup-rule-step-module"
	],
	"src/app/pages/contact-us/contact-us.module": [
		"./src/app/pages/contact-us/contact-us.module.ts",
		"src-app-pages-contact-us-contact-us-module"
	],
	"src/app/pages/feedback/feedback.module": [
...
var routes = [
    // { path: '', component: SiteLayoutComponent, data: { title: 'full Views' }, children: Full_ROUTES, canActivate: [AuthGuard] },
    { path: '', redirectTo: '/setup-rule', pathMatch: 'full' },
...
module.exports = __webpack_require__(/*! E:\bizlemTejal\carrotruleintegration\datefunc\2may\Algorithm_Builder-master\src\main.ts */"./src/main.ts");
